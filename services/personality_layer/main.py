...
from services.personality_layer.personality_layer import PersonalityLayer
...
async def handle_support_request(request: QuestionRequest):
    ...
    response = agent.run(request.raw_response, request.question)
    return response
